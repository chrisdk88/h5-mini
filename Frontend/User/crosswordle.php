...
<head>
    ...
    <title>DLES - Crosswordle</title>
</head>

<body class="<?= $crosswordleBackgroundColor ?>">
    <!-- Header -->
    ...
    <section>
        <div class="<?= $defaultCenterAndFixedHeight ?>">
            ...
            <div class="flex flex-col">
                <h1 class="<?= $sectionHeading ?>">Crosswordle</h1>
                <a href="<?= $baseURL ?>crosswordle-daily" class="<?= $redirectedButton ?>">Daily</a>
                <a href="<?= $baseURL ?>crosswordle-endless" class="<?= $redirectedButton ?>">Endless</a>
                <a href="<?= $baseURL ?>crosswordle-categories" class="<?= $redirectedButton ?>">Categories</a>
                <a href="<?= $baseURL ?>crosswordle-multiplayer" class="<?= $redirectedButton ?> mb-8">Multiplayer</a>
                <a href="<?= $baseURL ?>crosswordle-leaderboard" class="<?= $redirectedButton ?>">Leaderboard</a>
            </div>
            ...
            <div id="rulesModal" class="fixed inset-0 bg-black bg-opacity-25 flex items-center justify-center hidden">
                <div class="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full">
                    ...
                    <h2 class="text-xl font-bold mb-4 text-left">How to Play Crosswordle</h2>
