...
<head>
    ...
    <title>DLES - Crosswordle-Leaderboard</title>
...
<body class="<?= $crosswordleBackgroundColor ?>">
    ...
    <section>
        ...
        <div class="<?= $defaultCenterAndFixedHeight ?>">
            ...
            <!-- Back btn -->
            <a href="<?= $baseURL ?>crosswordle" class="absolute top-[100px] right-[30px] <?= $redirectedIcon ?> hidden md:block"> <svg
            ...
            <h1 class="<?= $sectionHeading ?>">Crosswordle Leaderboard</h1>

            <content>

                <main id="leaderboard-container-Crosswordle">
    ...
    <script src="/H5-mini/Frontend/User/Leaderboard/JavaScript/crosswordle-leaderboard.js"></script>
