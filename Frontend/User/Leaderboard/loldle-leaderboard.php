...
<head>
    ...
    <title>DLES - LoLdle-Leaderboard</title>
...
<body class="<?= $loldleBackgroundColor ?>">
    ...
    <section>
        ...
        <div class="<?= $defaultCenterAndFixedHeight ?>">
            ...
            <!-- Back btn -->
            <a href="<?= $baseURL ?>loldle" class="absolute top-[100px] right-[30px] <?= $redirectedIcon ?> hidden md:block"> <svg
            ...
            <h1 class="<?= $sectionHeading ?>">LoLdle Leaderboard</h1>

            <content>

                <main id="leaderboard-container-LoLdle">
    ...
    <script src="/H5-mini/Frontend/User/Leaderboard/JavaScript/loldle-leaderboard.js"></script>
