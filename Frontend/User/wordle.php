  ...
  <section>
    <div class="<?= $defaultCenterAndFixedHeight ?>">
      ...
      <div class="flex flex-col">
        <h1 class="<?= $sectionHeading ?>">Wordle</h1>
        <a href="<?= $baseURL ?>wordle-daily" class="<?= $redirectedButton ?>">Daily</a>
        <a href="<?= $baseURL ?>wordle-endless" class="<?= $redirectedButton ?>">Endless</a>
        <a href="<?= $baseURL ?>wordle-categories" class="<?= $redirectedButton ?>">Categories</a>
        <a href="<?= $baseURL ?>wordle-multiplayer" class="<?= $redirectedButton ?> mb-8">Multiplayer</a>
        <a href="<?= $baseURL ?>wordle-leaderboard" class="<?= $redirectedButton ?>">Leaderboard</a>
      </div>
