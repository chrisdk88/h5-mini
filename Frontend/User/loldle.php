...
<head>
    ...
    <title>DLES - LoLdle</title>
</head>

<body class="<?= $loldleBackgroundColor ?>">
    <!-- Header -->
    ...
    <section>
        <div class="<?= $defaultCenterAndFixedHeight ?>">
            ...
            <div class="flex flex-col">
                <h1 class="<?= $sectionHeading ?>">LoLdle</h1>
                <a href="<?= $baseURL ?>loldle-classic" class="<?= $redirectedButton ?>">Classic</a>
                <a href="<?= $baseURL ?>loldle-quote" class="<?= $redirectedButton ?>">Quote</a>
                <a href="<?= $baseURL ?>loldle-ability" class="<?= $redirectedButton ?>">Ability</a>
                <a href="<?= $baseURL ?>loldle-emoji" class="<?= $redirectedButton ?>">Emoji</a>
                <a href="<?= $baseURL ?>loldle-splash" class="<?= $redirectedButton ?>">Splash</a>
                <a href="<?= $baseURL ?>loldle-multiplayer" class="<?= $redirectedButton ?> mb-8">Multiplayer</a>
                <a href="<?= $baseURL ?>loldle-leaderboard" class="<?= $redirectedButton ?>">Leaderboard</a>
            </div>
            ...
            <div id="rulesModal" class="fixed inset-0 bg-black bg-opacity-25 flex items-center justify-center hidden">
                <div class="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full">
                    ...
                    <h2 class="text-xl font-bold mb-4 text-left">How to Play LoLdle</h2>
